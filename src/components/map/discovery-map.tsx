...
export function DiscoveryMap({ locations, selectedId, onSelect }: Props) {
  ...
  if (!isClient) {
    return (
      <div className="grid h-[430px] place-items-center rounded-2xl border border-slate-200 bg-sky-50 text-sm text-slate-500">
        Loading map…
      </div>
    );
  }
  ...
  return (
    <div className="h-[430px] overflow-hidden rounded-2xl border border-slate-200 bg-sky-50">
      <Map
        initialViewState={{ longitude: -84.5, latitude: 48.2, zoom: 4.1 }}
